...
const file_echo_proto_rawDesc = "" +
	...
	"\vEchoService\x12/\n" +
	"\x04Echo\x12\x11.echo.EchoRequest\x1a\x12.echo.EchoResponse\"\x00\x12=\n" +
	"\x10EchoClientStream\x12\x11.echo.EchoRequest\x1a\x12.echo.EchoResponse\"\x00(\x01\x12=\n" +
	"\x0eEchoBidiStream\x12\x11.echo.EchoRequest\x1a\x12.echo.EchoResponse\"\x00(\x010\x01Bo\n" +
	"\bcom.echoB\tEchoProtoP\x01Z&github.com/connectrpc-axum/test/go/gen\xa2\x02\x03EXX\xaa\x02\x04Echo\xca\x02\x05Echo_\xe2\x02\x11Echo_\\GPBMetadata\xea\x02\x04Echob\x06proto3"
...
var file_echo_proto_depIdxs = []int32{
	...
	0, // 1: echo.EchoService.EchoClientStream:input_type -> echo.EchoRequest
	0, // 2: echo.EchoService.EchoBidiStream:input_type -> echo.EchoRequest
	1, // 3: echo.EchoService.Echo:output_type -> echo.EchoResponse
	1, // 4: echo.EchoService.EchoClientStream:output_type -> echo.EchoResponse
	1, // 5: echo.EchoService.EchoBidiStream:output_type -> echo.EchoResponse
