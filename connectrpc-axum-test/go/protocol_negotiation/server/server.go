...
type protocolNegotiationServer struct {
	genconnect.UnimplementedHelloWorldServiceHandler
}

func (s *protocolNegotiationServer) GetGreeting(
	_ context.Context,
...
func (s *protocolNegotiationServer) SayHello(
	_ context.Context,
	req *connect.Request[gen.HelloRequest],
) (*connect.Response[gen.HelloResponse], error) {
	name := "World"
...
func main() {
	...
	path, handler := genconnect.NewHelloWorldServiceHandler(&protocolNegotiationServer{})
