Feature: connectrpc-axum-test integration behavior
  Scenarios were split into domain-focused feature files to keep this suite maintainable.

  Files:
    - features/01-core-unary.feature
