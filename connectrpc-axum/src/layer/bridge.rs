...
//!
//! The [`BridgeLayer`] bridges Tower compression middleware with
//! the Connect protocol's streaming compression requirements.
//!
...
//!
//! This layer ensures streaming requests don't get double-compressed by
//! setting `Accept-Encoding: identity` for streaming requests (prevents Tower from compressing response).
//!
